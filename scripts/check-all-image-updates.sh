...
$pythoncmd $scriptpath dpage/pgadmin4 4.6
$pythoncmd $scriptpath library/nginx 1.16 alpine
$pythoncmd $scriptpath library/nginx 1.16
$pythoncmd $scriptpath library/node 12.1 alpine
