<template>
    <div class="container">
        <div class="content-col col-md-8 offset-md-2 col-sm-12">
            ...
            <p>If you're a member of a volunteer oranization, or you're civically involved in Chicago, we'd love to hear from you. Feel free to contact us at <a href="mailto:theclipboardproject@gmail.com">theclipboardproject@gmail.com</a></p>
        </div>
    </div>
</template>